            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        ...
                        <!-- Opción Clientes -->
                        <li class="nav-item">
                            <a href="{{ route('enterprise.clientes.index') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="{{ route('enterprise.facturas.create') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Agregar Factura</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('enterprise.facturas.index') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Listar Facturas</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a  href="{{ route('enterprise.productos.create') }}"  class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Agregar Producto</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a  href="{{ route('enterprise.productos.index') }}"  class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Listar Productos</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a  href="{{ route('enterprise.categorias.index') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
